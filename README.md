...
Static site for elevat8.com — no build step, plain HTML/CSS/JS.
...
- `CNAME` — points GitHub Pages at elevat8.com

## Deployment (GitHub Pages)
This repo is set up to deploy automatically to GitHub Pages on every push to `main`.

**To point elevat8.com at it:** add these DNS records at your domain registrar (GoDaddy, Namecheap, etc.):
